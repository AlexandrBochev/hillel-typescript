function lesson5() {
  ...
  function discriminatedUnions() {
    ...
    // type TSquare = {
    //   kind: typeof KIND.CIRCLE; // pay attention to the literal type - this is not a value, but a type
    //   size: number;
    // };

    // type TSquare = {
    //   kind: KIND2.SQUARE; // pay attention to the literal type - this is not a value, but a type
    //   size: number;
    // };
    ...
    type TKind = "square" | "rectangle" | "circle";
